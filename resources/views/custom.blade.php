...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="body">
        ...
        <div class="allcontainer">
            <div class="containerdefault muurschildering">
                <div class="tablecelldivs">
                    <h2 style="width: 146px;" class="ourstorytitle">Custom</h2>
                ...
                <p>Elke kamer, buitenmuur, kantoor of lokaal kan omgetoverd worden tot een waar kunstwerk! Geniet bovendien van een ruim aanbod aan artiesten
                met elk hun eigen stijl. Zo vind u zeker een artiest die voldoet aan uw wensen!</p>
                ...
                <img src="{{ asset('img/custom1.jpg') }}"/>
                <img src="{{ asset('img/custom2.jpg') }}"/>
                <img src="{{ asset('img/custom3.jpg') }}"/>
